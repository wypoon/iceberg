...
public class SparkSQLProperties {
  ...
  // Threshold for number of positional deletes present to use a streaming filter rather than a filter set;
  // below this number, the deletes are held in memory
  public static final String STREAM_DELETE_FILTER_THRESHOLD = "spark.sql.iceberg.stream.delete.filter.threshold";
