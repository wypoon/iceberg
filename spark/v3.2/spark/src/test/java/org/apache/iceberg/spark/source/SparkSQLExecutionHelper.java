...
public class SparkSQLExecutionHelper {
  ...
  /**
   * Finds the value of a specified metric for the last SQL query that was executed.
   * Metric values are stored in the `SQLAppStatusStore` as strings.
  ...
  public static String lastExecutedMetricValue(SparkSession spark, String metricName) {
    ...
    Assert.assertTrue(String.format("Metric '%s' not found in last execution", metricName), sqlPlanMetric.isDefined());
